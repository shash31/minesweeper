window.addEventListener('DOMContentLoaded', () => {
    ...
    const minesound = new Audio('/minesweeper/assets/tick.mp3');
    const flagsound = new Audio('/minesweeper/assets/flag.mp3');
    const unflagsound = new Audio('/minesweeper/assets/unflag.mp3');
    const winsound = new Audio('/minesweeper/assets/win.mp3');
    const losesound = new Audio('/minesweeper/assets/lose.mp3');
